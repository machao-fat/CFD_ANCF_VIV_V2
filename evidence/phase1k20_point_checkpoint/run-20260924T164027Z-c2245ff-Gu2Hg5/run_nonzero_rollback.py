...
ADAPTER = RUN / "build/libpreciceAdapterPhase1K20.so"
...
EXPECTED = {
    ...
    "diag_adapter": "225ecab227b8271f01119fe476370e3a0b705ca06e1ca3a7739200266499b165",
    "diag_adapter_build_id": "d1a7fca8f75aea43f9b3b8d7904e57a6ac90c627",
...
def process_maps(pid: int) -> list[str]:
    ...
    return [line for line in path.read_text(errors="replace").splitlines()
            if any(token in line for token in ("libprecice.so", "libpreciceAdapterPhase1K20", "libRBFMeshMotionSolverPhase1K187BStopDiag", "cfd_ancf_ancf_kernel_worker"))]
